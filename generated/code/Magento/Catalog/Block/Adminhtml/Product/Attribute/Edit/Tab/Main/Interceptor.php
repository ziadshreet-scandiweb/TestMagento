...
class Interceptor extends \Magento\Catalog\Block\Adminhtml\Product\Attribute\Edit\Tab\Main implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAttributeObject');
        return $pluginInfo ? $this->___callPlugins('setAttributeObject', func_get_args(), $pluginInfo) : parent::setAttributeObject($attribute);
    }
